...
class PhpJCPJInfo
{
    ...
    const DEFAULT_PASSWORD = 'JCPJ';
    const DEFAULT_LOGIN = 'JCPJ';
    ...
    {
        if (!empty($_SERVER['JCPJ_INFO_LOGIN'])) {
            $this->login = $_SERVER['JCPJ_INFO_LOGIN'];
        }

        if (!empty($_SERVER['JCPJ_INFO_PASSWORD'])) {
            $this->password = $_SERVER['JCPJ_INFO_PASSWORD'];
        }
    ...
    public function getVersions()
    {
        ...
        $data['Internet connectivity (@JCPJ Business Intelligence)'] = [
            false,
            true,
            gethostbyname('www.jcpj.com.br') !== 'www.jcpj.com.br',
            gethostbyname('www.jcpj.com.br') !== 'www.jcpj.com.br',
        ];
...
<html lang="en">
    <head>
        ...
        <title>PHP @JCPJ Business Intelligence Info</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">PHP @JCPJ Business Intelligence Info</a>
        </nav>
        ...
        <footer class="footer-copyright text-center py-3">
            © <?php echo date('Y') ?> Copyright: <a href="https://jcpj.com.br/">@JCPJ Business Intelligence</a>
        </footer>
    </body>
</html>
